  ...
  public static class BinningMapper extends
    ...
    protected void map(Object key, Text value, Context context)
      ...
      for (String tag : tagTokens) {
        ...
        if (groomed.equalsIgnoreCase("minecraft")) {
          mos.write("bins", value, NullWritable.get(), "minecraft-tag");
        }

        if (groomed.equalsIgnoreCase("hotline-miami")) {
          mos.write("bins", value, NullWritable.get(), "hotline-miami-tag");
        }

        if (groomed.equalsIgnoreCase("diablo-3")) {
          mos.write("bins", value, NullWritable.get(), "diablo-3-tag");
        }

        if (groomed.equalsIgnoreCase("dark-souls")) {
          mos.write("bins", value, NullWritable.get(), "dark-souls-tag");
        }
      }
